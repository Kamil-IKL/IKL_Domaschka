...
# Функция декоратор (is_prime), которая распечатывает "Простое" (ЧИСЛО ДЕЛИТСЯ ТОЛЬКО НА СЕБЯ И 1), если результат 
# 1ой функции будет простым числом и "Составное" (ЧИСЛО ДЕЛИТСЯ НЕ ТОЛЬКО НА СЕБЯ И 1) в противном случае.
